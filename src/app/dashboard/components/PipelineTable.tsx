...
type Props = {
  ...
  // Aksi di baris (dari kolom Action)
        ...
        <table className="w-full border-collapse text-[11px]">
          <thead className="bg-slate-50">
            <tr className="text-left text-slate-600">
              <th className="px-3 py-2 w-[90px]">Produk</th>
              <th className="px-3 py-2 min-w-40">Nasabah</th>
              <th className="px-3 py-2 w-[170px]">Marketer / Branch / Class</th>
              <th className="px-3 py-2 text-right w-[120px]">APE (IDR / USD)</th>
              <th className="px-3 py-2 w-[110px]">Plan / Tanggal</th>
                ...
                <td className="px-3 py-2 text-center align-top">
                  <div className="inline-flex items-center gap-1">
                    ...
                    <button
                      ...
                      title="Hapus"
                    >
                      <span className="text-[11px] text-red-600">🗑️</span>
                    </button>
                  </div>
                </td>
              </tr>
